...
## IMPORTANT: This branch works with a modified version of Dice to allow switching on and off cartesian mode
git clone https://github.com/jrm874/Dice.git $(pwd)/external/Dice
